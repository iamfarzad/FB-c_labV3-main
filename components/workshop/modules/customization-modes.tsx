              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }}>
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-2"><label className="text-sm font-medium">Training Data</label><div className="bg-muted/30 p-3 rounded-md text-sm"><div className="mb-2"><div className="font-medium">Example 1:</div><div className="pl-2 border-l-2 border-muted-foreground/30 mt-1"><div><span className="text-[hsl(var(--accent))]">Input:</span> Summarize the quarterly results</div><div><span className="text-[hsl(var(--chart-success))]">Output:</span> Q1 revenue increased by 15%...</div></div></div><div><div className="font-medium">Example 2:</div><div className="pl-2 border-l-2 border-muted-foreground/30 mt-1"><div><span className="text-[hsl(var(--accent))]">Input:</span> Analyze market trends</div><div><span className="text-[hsl(var(--chart-success))]">Output:</span> The market shows three key trends...</div></div></div></div></div>
